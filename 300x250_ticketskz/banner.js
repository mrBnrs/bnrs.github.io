...
// stage content:
(lib._300x250_ticketskz = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(150.1,21.3,0.636,0.636,0,0,0,0.1,0.1);
	...
	this.plane2.setTransform(303.9,66.1,0.635,0.635,0,0,0,0.1,0.1);
	...
	this.plane1.setTransform(311.6,39.5,0.635,0.635,0,0,0,0,0.1);
	...
	this.t3 = new lib.t3();
	this.t3.parent = this;
	this.t3.setTransform(148.2,220.3);
	...
	this.t2 = new lib.t2();
	this.t2.parent = this;
	this.t2.setTransform(149.9,220.3);
	...
	this.t1 = new lib.е1();
	this.t1.parent = this;
	this.t1.setTransform(149.9,220.3);
	...
	this.clouds2.setTransform(-1153.3,155.1,1,1,0,0,0,-763,-3);
...
p.nominalBounds = new cjs.Rectangle(-948.9,136.7,1410.6,230.6);
// library properties:
lib.properties = {
	width: 300,
	height: 250,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/cloud.png?1498309280111", id:"cloud"},
		{src:"images/plane1.png?1498309280111", id:"plane1"},
		{src:"images/plane2.png?1498309280111", id:"plane2"}
	],
	preloads: []
};
