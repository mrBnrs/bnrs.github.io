...
(lib.platee = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(62.4,-24.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AA7B+IAAioIh3CoIgzAAIAAj7IA1AAIAACiIB0iiIA3AAIAAD7g");
	this.shape_1.setTransform(37.7,-24.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABOCVIAAguIibAAIAAAuIg2AAIAAhZQAJgBAIgEQAIgDAFgJQAGgJAEgPQAEgOAEgYIAPiBICxAAIAADLIAXAAIAABegAgegQQgDAZgHARQgIATgNAKIB0AAIAAicIhLAAg");
	this.shape_2.setTransform(10.2,-21.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhYB+IAAj7ICxAAIAAAvIh8AAIAAA2IB5AAIAAAuIh5AAIAAA5IB8AAIAAAvg");
	this.shape_3.setTransform(-14.6,-24.2);
	...
	this.shape_4.setTransform(-36.8,-24.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AApB+IhLhlIgTAXIAABOIg2AAIAAj7IA2AAIAABxIBYhxIBCAAIhkB2IBrCFg");
	this.shape_5.setTransform(-60.1,-24.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(50.7,-69.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgkCvIAAkcIhnAAIAAhBIEXAAIAABBIhnAAIAAEcg");
	this.shape_7.setTransform(15.3,-69.2);
...
}).prototype = getMCSymbolPrototype(lib.platee, new cjs.Rectangle(-80,-134,160,135.9), null);
...
(lib.arrrow__text = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgIA5QgDgDgBgGQABgEADgFQAEgDAEAAQAFAAAEADQADAFABAEQgBAGgDADQgEAEgFAAQgEAAgEgEgAgHAWIgEhSIAXAAIgEBSg");
	this.shape.setTransform(76.1,-0.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAlA8IgJgXIg2AAIgJAXIgZAAIAwh3IAZAAIAwB3gAAVATIgVg5IgVA5IAqAAg");
	this.shape_1.setTransform(67.8,-1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAqA8IAAhYIglBYIgIAAIglhYIAABYIgWAAIAAh3IAfAAIAfBOIAhhOIAdAAIAAB3g");
	...
	this.shape_3.setTransform(41.8,-1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ag3ArQAFAAADgCQAEgCADgEQADgEACgJIAEgWIAHg8IBQAAIAAB3IgVAAIAAhlIgoAAIgGAsQgDAXgDAIIgEAKQgCAFgDADQgGAGgHACQgHACgJAAg");
	this.shape_4.setTransform(29.5,-0.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgtA8IAAh3IBRAAIAAASIg8AAIAAAbIAfAAQAJAAAHADQAIACAFAGQAFAEACAHQADAHAAAHQAAAIgDAHQgCAGgFAGQgFAFgHADQgIADgJAAgAgYApIAcAAQAEAAAEgBIAHgDIAEgHQABgEAAgEQAAgEgBgEIgEgFIgHgFIgIgBIgcAAg");
	this.shape_5.setTransform(18.4,-1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(5.6,-1);
	...
	this.shape_7.setTransform(-6.3,-1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAgA8IAAhlIg+AAIAABlIgWAAIAAh3IBoAAIAAB3g");
	...
	this.shape_9.setTransform(-34.7,-1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAfA8IAAg0Ig9AAIAAA0IgVAAIAAh3IAVAAIAAAxIA9AAIAAgxIAWAAIAAB3g");
	this.shape_10.setTransform(-46.6,-1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgvAIIAAgPIBfAAIAAAPg");
	this.shape_11.setTransform(-63,0.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAfA8IAAhVIg+BVIgUAAIAAh3IAVAAIAABSIA8hSIAWAAIAAB3g");
	this.shape_12.setTransform(-79.4,-1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgoA8IAAh3IBRAAIAAASIg8AAIAABlg");
	this.shape_13.setTransform(-90.6,-1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgtA8IAAh3IAVAAIAAAtIAfAAQAJAAAHADQAIACAFAGQAFAEACAHQADAHAAAHQAAAIgDAHQgCAGgFAGQgFAFgHADQgIADgJAAgAgYApIAcAAQAEAAAEgBIAHgDIAEgHQABgEAAgEQAAgEgBgEIgEgFIgHgFIgIgBIgcAAg");
	this.shape_14.setTransform(-101,-1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AAfA8IAAg0Ig9AAIAAA0IgVAAIAAh3IAVAAIAAAxIA9AAIAAgxIAVAAIAAB3g");
	this.shape_15.setTransform(-113.4,-1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgoA8IAAh3IBRAAIAAASIg8AAIAAAgIA7AAIAAARIg7AAIAAAhIA8AAIAAATg");
	this.shape_16.setTransform(-124.9,-1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AApBHIAAgWIhRAAIAAAWIgVAAIAAgmQAGgBADgCQAEgCACgDQADgFACgIIAEgVIAHg9IBRAAIAABkIALAAIAAApgAgQgHQgDAQgDAHQgEAIgGAGIA+AAIAAhSIgpAAg");
	this.shape_17.setTransform(-136.7,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.arrrow__text, new cjs.Rectangle(-145.4,-13.6,225.9,25.9), null);


(lib.arrr = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(2,1,1).p("ATygYQAbAYgbAbIjKB+QgJAGgRAAMgjoAAAQglAAAAgkIAAj1QAAgkAlAAMAjoAAAQASAAAJAIg");
	...
	// Layer 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D82231").s().p("A0CDIQgoAAAAgnIAAlBQAAgnAoAAMAkUAAAQASAAAKAIIDvCjQAcAbgdAbIjvCnQgKAHgRAAg");
	this.shape_1.setTransform(27.6,0);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.arrr, new cjs.Rectangle(-104.6,-20,264.6,40.1), null);
...
(lib.arrow = function(mode,startPosition,loop) {
	...
	this.t.parent = this;
	this.t.setTransform(-174,-0.1,1,1,0,0,0,-67.8,0);
	...
	this.instance.parent = this;
	this.instance.setTransform(-162,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.arrow, new cjs.Rectangle(-266.7,-20,264.6,40.1), null);


// stage content:
(lib._300x250_swisscapital_cc = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.plate.setTransform(149,95.7);
	...
	this.cur.setTransform(198,217.2);
	...
	this.url.setTransform(150,220.4,1.219,1.219,0,0,0,0,13.1);
	...
	this.logo2.setTransform(150.7,113.6,1.228,1.209,0,0,0,0.5,0.1);
	...
	this.phone.setTransform(150,167.9);
	...
	this.logo1.setTransform(73.3,6.7);
	...
	this.keys.setTransform(161.4,181,0.722,0.722,0,0,0,-295,277);
	...
	this.car.setTransform(270.5,87.3,0.768,0.768);
	...
	this.arrow.setTransform(205,229,0.784,0.784);
	...
	this.t1.parent = this;
	this.t1.setTransform(108.5,192.6,0.884,0.884,0,0,0,112,21.4);

	this.timeline.addTween(cjs.Tween.get(this.t1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(146,86.7,378.4,287.4);
// library properties:
lib.properties = {
	id: 'FF7218B9BA7E409BA32698DE7C7DCF0E',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"banner_atlas_.png?1502008239359", id:"banner_atlas_"}
	],
	preloads: []
};
...
an.compositions['FF7218B9BA7E409BA32698DE7C7DCF0E'] = {
