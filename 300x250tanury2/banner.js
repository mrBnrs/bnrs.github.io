...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1479688870174", id:"bg"},
		{src:"images/flat.jpg?1479688870174", id:"flat"},
		{src:"images/p1.png?1479688870174", id:"p1"},
		{src:"images/p2.png?1479688870174", id:"p2"},
		{src:"images/p3.png?1479688870174", id:"p3"},
		{src:"images/sht.jpg?1479688870174", id:"sht"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,545,307);


(lib.flat = function() {
	this.initialize(img.flat);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,342,318);


(lib.p1 = function() {
	this.initialize(img.p1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,165,319);


(lib.p2 = function() {
	this.initialize(img.p2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,241,318);


(lib.p3 = function() {
	this.initialize(img.p3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,257,313);


(lib.sht = function() {
	this.initialize(img.sht);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,288,251);
...
(lib.sht_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.sht();
	this.instance.setTransform(-144,-125.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-144,-125.5,288,251);
...
(lib.Symbol10_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-128.5,-313);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-128.5,-313,257,313);
...
(lib.Symbol9_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-120.5,-318);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-120.5,-318,241,318);
...
(lib.Symbol8_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-82.5,-319);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-82.5,-319,165,319);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFAFF").s().p("AgYA+Igag8IAxhAIA0BHIgZA1IgdAAIgVAAg");
...
(lib.bggg = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-545,-153.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-545,-153.5,545,307);
...
(lib.par = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// Layer 3
	this.p3 = new lib.Symbol10_1();
	this.p3.setTransform(-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.p3).wait(3));

	// Layer 2
	this.p2 = new lib.Symbol9_1();
	this.p2.setTransform(-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.p2).wait(3));

	// Layer 4
	this.p12 = new lib.Symbol8_1();
	this.p12.setTransform(-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.p12).wait(3));

	// Layer 1
	this.p11 = new lib.Symbol8_1();
	this.p11.setTransform(-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.p11).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-129,-319,257,319);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 5
	this.par = new lib.par();
	this.par.setTransform(293.4,127.9,0.219,0.219,0,0,0,0,-159.6);
	this.par.alpha = 0.43;

	this.timeline.addTween(cjs.Tween.get(this.par).wait(1));

	// Layer 3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(170.6,158.8);
	...
	// Layer 2
	this.wht = new lib.sht_1();
	this.wht.setTransform(144.1,124.8);
	this.wht.alpha = 0.879;

	this.timeline.addTween(cjs.Tween.get(this.wht).wait(1));

	// Layer 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(255,255,255,0)","#FFFFFF"],[0,1],-2.1,-23.9,0.2,12).s().p("AwehkIAAjIMAgNgCIIAwLhMggaACIg");
	this.shape_1.setTransform(104.9,171.4,0.993,1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["rgba(255,255,255,0)","#FFFFFF"],[0,1],-24,0,12,0).s().p("AlwSRIAAhjIBFAAIAAt7IhFAAIAA1EILiAAMAAAAkig");
	this.shape_2.setTransform(251.2,116.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.1,-1,341.1,318);
...
(lib.grune = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00AEB1").s().p("Egt4AV4MAatgruMBBEAAAMAAAArug");
	this.shape.setTransform(293.8,-140);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-280,587.5,280);


// stage content:
(lib._300x250tanury2 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		twp.to(par.p12, 1, {alpha: 0, scaleX: '+=.3', scaleY: '+=.3', ease: Linear.easeNone}); 
		twp.from(par.p2, 1, {alpha: 0, scaleX: '-=.3', scaleY: '-=.3', ease: Linear.easeNone}, 'p2'); 
		
		twp.to(par.p2, 1, {alpha: 0, scaleX: '+=.3', scaleY: '+=.3', ease: Linear.easeNone}, 'p2+=1'); 
		twp.from(par.p3, 1, {alpha: 0, scaleX: '-=.3', scaleY: '-=.3', ease: Linear.easeNone}, 'p3'); 
		
		
		twp.to(par.p3, 1, {alpha: 0, scaleX: '+=.3', scaleY: '+=.3', ease: Linear.easeNone}, 'p3+=1'); 
		twp.from(par.p11, 1, {alpha: 0, scaleX: '-=.3', scaleY: '-=.3', ease: Linear.easeNone}, 'p1'); 
	...
	this.grune2.setTransform(-224.5,250,0.893,0.893);

	this.timeline.addTween(cjs.Tween.get(this.grune2).wait(1));

	// Layer 1
	this.grune = new lib.grune();
	this.grune.setTransform(-224.5,250,0.893,0.893);

	this.timeline.addTween(cjs.Tween.get(this.grune).wait(1));

	// Layer 2
	this.plate = new lib.Symbol7();
	this.plate.setTransform(-8.7,196.1,0.893,0.893,0,0,0,-207.2,21.6);

	this.t2 = new lib.t2();
	this.t2.setTransform(70.8,94,0.893,0.893,0,0,0,-66.2,35.6);

	this.t1 = new lib.Symbol3_1();
	this.t1.setTransform(81.2,40.4,0.893,0.893,0,0,0,-78,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.t1},{t:this.t2},{t:this.plate}]}).wait(1));

	// Layer 3
	this.flat = new lib.Symbol2_1();
	this.flat.setTransform(0.9,116.1,0.893,0.893,0,0,0,1,130);

	this.timeline.addTween(cjs.Tween.get(this.flat).wait(1));

	// bg
	this.bg = new lib.bggg();
	this.bg.setTransform(114.3,60.2,0.893,0.893,0,0,0,-208,-59);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-74.6,100.9,529.9,309.3);
